    ...
    createStyles() {
        ...
        style.innerHTML = `
            .btn-qrtdogd-floating-button {
                ...
                width: 60px;
                height: 60px;
                background-image: url('https://media2.giphy.com/media/LWYj2JxzlJteRcgWHX/200.webp');
...
<head>
    ...
    <title>Floater Button Demo</title>
</head>
<body>
   

    <script src="floater_button.js"></script>
</body>
</html>
EOF

echo "Open the html to preview floater"
